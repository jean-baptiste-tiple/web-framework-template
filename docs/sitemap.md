# Sitemap (exemple du template)

| Page | Type | URL | Objectif | CTA | Intention SEO |
| --- | --- | --- | --- | --- | --- |
| Accueil | home (.astro) | / | Présenter + router | Voir le blog | marque |
| Blog | blog-index | /blog | Lister les articles | — | "blog <thème>" |
