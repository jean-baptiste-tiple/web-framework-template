...
Fichiers : src/components/ui/ContactForm.astro (composant vanilla, `<script>` intégré), src/pages/contact.astro, variable PUBLIC_FORM_ENDPOINT (.env en local, env de BUILD chez l'hébergeur : la valeur est inlinée au build).
